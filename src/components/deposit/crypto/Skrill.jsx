    ...
    <div className="flex">
      ...
      <div className=" w-[70%] lg:w-[70%] xl:w-[70%] mx-auto relative z-10 m-2 rounded mt-4">
        ...
        <div className="mx-auto relative z-10 m-2 rounded mt-20 p-4 bg-white shadow-md">
          <h1 className="text-xl font-bold mb-4">Skrill/Moneybookers</h1>
          <p>How to fund your account with Skrill/Moneybookers</p>
          <ol className="list-decimal list-inside mb-4 text-xs">
            <li>Complete the form below and press ‘Submit’</li>
            <li>Log in to your Skrill/Moneybookers account</li>
            <li>
              Follow the prompts in Skrill/Moneybookers account to complete your
              payment
            </li>
            <li>We can accept payment in USD, EUR, GBP and CAD</li>
          </ol>
