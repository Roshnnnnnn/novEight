...
//   return (
//     <div className={`hidden md:block ${isModalOpen ? "blur" : ""}`}>
...
//           {isDropdownOpen && (
//             <div
//               className="absolute right-0 mt-2 p-2 w-60 bg-white shadow-lg rounded-md text-xs z-[9999]"
...
//         >
//           <div
//             className="bg-white p-8 rounded-xl shadow-lg w-[35rem] h-auto z-60"
...
const Head = () => {
  ...
  return (
    <div className={" relative hidden md:block"}>
      <div className="top-0 left-0 right-0 flex justify-end items-center p-4 fixed bg-white bg-opacity-50 backdrop-blur-sm z-20">
        <FiGlobe className="text-teal-900 cursor-pointer ml-4 w-8" />
        <FiBell
          className="text-teal-900 cursor-pointer ml-4 w-8"
          onClick={handleNotificationClick}
        ...
        <div className="relative">
          ...
          {isDropdownOpen && (
            <div
              className="absolute right-0 mt-2 p-2 w-60 bg-white shadow-lg rounded-md text-xs z-30"
              onClick={handleDropdownClick}
            >
              <div className="pt-2 pl-2 text-sm font-bold">{userNames}</div>
              {/* <div className="pl-2" style={{ fontSize: "12px" }}>
                UID: 2659752
              </div> */}
              <div
